...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/10/14 16:51:02 by rcherik           #+#    #+#             */
/*   Updated: 2016/10/14 16:51:03 by rcherik          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::string was = "\033[31mOverflow Exception : " + std::string(std::runtime_error::what()) + ".\033[0m";
	return was.c_str();
}
...
{
	std::string was = "\033[31mUnderflow Exception : " + std::string(std::runtime_error::what()) + ".\033[0m";
	return was.c_str();
}
