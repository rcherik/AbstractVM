...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/10/14 16:50:59 by rcherik           #+#    #+#             */
/*   Updated: 2016/10/14 16:51:01 by rcherik          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (_vm->size() < 2)
		throw EmulatorException(("\033[31mMissing operand.\033[0m"));
...
void 				  Emulator::_Assert(std::string str) const
{
	...
	if (!(*a == *b))
		throw EmulatorException(("\033[31mAssert Error.\033[0m"));
}
